...
interface Dao {
    ...
    @Query("SELECT * FROM menu WHERE uuid=:id")
    fun getDetailMenu(id:Int): List<Menu>

    @Query("SELECT * FROM menu WHERE resto_id=:resto_id")
    fun getMenus(resto_id:Int): List<Menu>
