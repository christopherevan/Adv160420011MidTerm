...
import com.yeet.anmp160420011midterm.databinding.OrdersItemBinding
...
class OrderListAdapter(val orderList:ArrayList<Order>)
    : RecyclerView.Adapter<OrderListAdapter.OrderViewHolder>(), ButtonDetailClickListener
{
    class OrderViewHolder(var view: OrdersItemBinding) : RecyclerView.ViewHolder(view.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OrderViewHolder {
        val inflater = LayoutInflater.from(parent.context)
//        val view = inflater.inflate(R.layout.orders_item, parent, false)
        val view = DataBindingUtil.inflate<OrdersItemBinding>(inflater, R.layout.orders_item, parent, false)
...
//        }
    ...
    override fun onButtonDetailClick(v: View) {
        val action = OrdersFragmentDirections.actionOrderDetailFromOrders(v.tag.toString().toInt())
